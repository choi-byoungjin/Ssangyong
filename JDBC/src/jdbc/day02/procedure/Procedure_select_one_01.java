		...
		try {
			...
			*/
			...
			if( cstmt.getString(2) == null ) {
				...
				System.out.println("-----------------------------------------------");
				System.out.println("▶ 학생명 : " + cstmt.getString(2)); // 숫자 2는 프로시저 파라미터중 두번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("▶ 연락처 : " + cstmt.getString(3)); // 숫자 3는 프로시저 파라미터중 세번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("▶ 주 소 : " + cstmt.getString(4)); // 숫자 4는 프로시저 파라미터중 네번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("▶ 입학일자 : " + cstmt.getString(5)); // 숫자 5는 프로시저 파라미터중 다섯번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("▶ 학급명 : " + cstmt.getString(6)); // 숫자 6는 프로시저 파라미터중 여섯번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("▶ 교사명 : " + cstmt.getString(7)); // 숫자 7는 프로시저 파라미터중 일곱번재 파라미터의 ?(OUT MODE)를 말한다.
				System.out.println("-----------------------------------------------");
			}
