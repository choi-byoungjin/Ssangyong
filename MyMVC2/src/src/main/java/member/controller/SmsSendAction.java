...
public class SmsSendAction extends AbstractController {
	...
	//	String api_secret = "발급받은 본인의 API Secret";  // 발급받은 본인 API Secret
		...
		Message coolsms = new Message(api_key, api_secret); // import net.nurigo
	...
	//	2020년 10월 16일 이후로 발신번호 사전등록제로 인해 등록된 발신번호로만 문자를 보내실 수 있습니다
		...
		if(datetime != null) {
		//	paraMap.put("datetime", "202204051120"); // 예약전송시 날짜 설정 반드시 YYYYMMDDHHMISS 형식대로 해야함.
	...
	//	~~~~ 확인용 json => {"group_id":"R2GhVMuwEqSJjDJ4","success_count":1,"error_count":0}
