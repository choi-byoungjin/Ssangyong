...
public class GoogleMail {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
        ...
        prop.put("mail.smtp.user", "cbj4056@gmail.com");
        ...
        Authenticator smtpAuth = new MySMTPAuthenticator();	// 인증을 받기 위한 ID, 앱비밀번호가 smtpAuth에 들어옴
        ...
        // 보내는 사람의 메일주소
        String sender = "cbj4056@gmail.com";
