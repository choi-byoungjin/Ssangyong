...
<p id="my_title">
	...
	<%-- 변수 이름이 충돌하지 않으면 pageScope, requestScope, sessionScope는 생략가능, but 표기해두는것이 좋음 --%>
</p>
<%-- 끝 --%>
	...
	<div class="container">
		...
		<div id="carouselExampleIndicators" class="carousel slide carousle-fade" data-ride="carousel">
		  ...
		  --%>
		  	<c:forEach items="${requestScope.imgList}">
