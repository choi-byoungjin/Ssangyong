         ...
         <tbody>
                   ...
                   <tr>
                        ...
                        <td align="center"> 
                            <%-- 현재주문수량 --%>
                              ...
                              <button class="btn btn-outline-secondary btn-sm updateBtn" type="button" onclick="">수정</button>
                        ...
                        <td align="center"> <%-- 장바구니에서 해당 특정 제품 비우기 --%> 
                            <button class="btn btn-outline-danger btn-sm" onclick="">삭제</button>  
                        </td>
                    </tr>
                 </c:forEach>
            </c:if>   
            ...
            <tr>
                 ...
                 <td colspan="3" align="center">
                  <button class="btn btn-outline-dark btn-sm mr-3" onclick="">주문하기</button>
