...
<c:set var="name2" value="교육센터" /> <%-- 생략하면 scope="page"이다. --%>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top mx-4 py-3">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
		  <ul class="navbar-nav" style="font-size: 16pt;">
			 ...
			 <c:if test="${not empty sessionScope.loginuser && sessionScope.loginuser.userid == 'admin'}"> <%-- admin으로 로그인 했으면 --%> <%-- &&은 and ==는 eq 사용가능 --%>
