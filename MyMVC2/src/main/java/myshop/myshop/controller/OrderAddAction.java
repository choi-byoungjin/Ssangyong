...
public class OrderAddAction extends AbstractController {
	...
	private String getOdrcode() throws SQLException {
	    ...
	    // pdao.getSeq_tbl_order(); 는 시퀀스 seq_tbl_order 값을 채번해온 것이다.
	...
	/*	
		...
		~~~~~~~~~~~~ 확인용 oqtyjoin : 4,2
		~~~~~~~~~~~~ 확인용 cartnojoin : 3,1
		~~~~~~~~~~~~ 확인용 totalPricejoin : 40000,20000
		~~~~~~~~~~~~ 확인용 sumtotalPrice : 60000
		~~~~~~~~~~~~ 확인용 sumtotalPoint : 220
	*/
		// ===== Transaction 처리하기 ===== // 
		...
		// == 주문상세 테이블에 insert == //
		// 1. 전표(주문코드)를 가져오기는 위에서 만들어서 넣어둠
		// 2. 제품번호
		...
		// ======== 제품 테이블 update 하기 ======== //
		// 1. 제품테이블의 잔고량 컬럼의 값을 주문량 만큼 감해야 하는데 이미 위해서 위에서 주문량을 구해서 맴에 넣어둠.
