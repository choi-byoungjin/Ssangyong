			...
			// === 첨부 이미지 파일을 올렸으니 그 다음으로 제품정보를 (제품명, 정가, 제품수량,...) DB의 tbl_product 테이블에 insert 를 해주어야 한다.  ===
				...
				*/
				...
				/*				
					...
					System.out.println("### 확인용 pimage1_originFileName => " + pimage1_originFileName); ### 확인용 pimage1_originFileName => 쉐보레전면.jpg   쉐보레전면.jpg
					System.out.println("### 확인용 pimage2_originFileName => " + pimage2_originFileName); ### 확인용 pimage2_originFileName => 쉐보레후면.jpg   쉐보레후면.jpg									 
					// 유저가 올린 파일이름
				 */
				...
				//	System.out.println("~~~ 확인용 prdmanual_systemFileName => " + prdmanual_systemFileName);
					// ~~~ 확인용 prdmanual_systemFileName => null // 첨부파일 없으면 null
				 ...
				 */
					...
					pvo.setPnum(pnum);
					pvo.setFk_cnum(Integer.parseInt(fk_snum));
					...
					//	System.out.println("~~~ 확인용 추가이미지 파일갯수 str_attachCount => " + str_attachCount);
