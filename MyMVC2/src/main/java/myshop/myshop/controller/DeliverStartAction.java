	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//	super.setRedirect(false);
			...
			if(!"admin".equals(userid) ) {
				...
				/*
				   's20220414-9/60','s20220412-8/6','s20220412-8/4','s20220412-5/5','s20220412-5/4' 
				   's20220414-9 은 주문코드(전표)' 이고 /뒤에 붙은 60 은 제품번호이다. 
			...
			//	System.out.println("~~~~ 확인용 odrcodePnum => " + odrcodePnum);
				// ~~~~ 확인용 odrcodePnum => 's20220414-9/60','s20220412-8/6','s20220412-8/4','s20220412-5/5','s20220412-5/4' 
				...
				try {
					 ...
					 if(n==odrcodeArr.length) {
						// == **** 배송을 했다라는 확인 문자(SMS)를 주문을 하신분(여러명)에게 보내기 시작 **** == //
						...
						for(String key : odrcodeMapKeysets) {
							...
							// String api_key = "발급받은 본인의 API Key";  // 발급받은 본인 API Key
							   String api_key = "NCSVHMGRZBFOIF0C"; 
							
							// String api_secret = "발급받은 본인의 API Secret";  // 발급받은 본인 API Secret  
							   String api_secret = "DXCC8SPDKZRKDMJE9PW6SZG1EKMTKXUR";
						...
						// == **** 배송을 했다라는 확인 문자(SMS)를 주문을 하신분(여러명)에게 보내기 끝 **** == //
