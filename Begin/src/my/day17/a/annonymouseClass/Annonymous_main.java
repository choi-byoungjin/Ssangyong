...
public class Annonymous_main {
	...
	public static void main(String[] args) {
		...
		double areaSize2 = area2.area(20.5, 5.5);
		System.out.println("가로 20.5, 세로 5.5 인 면적은 : " + areaSize2);
		// 가로 20.5, 세로 5.5 인 면적은 : 112.75
	...
	*/
		...
		InterArea areaObj = new InterArea() { // 객체를 만들어서 인터페이스로 받는다
		...
		}; // 클래스를 정의하는 것과 객체를 생성하는 것을 동시에 한다.
		
		double areaSize3 = areaObj.area(10.5, 5.5);
		System.out.println("가로 10.5, 세로 5.5 인 면적은 : " + areaSize3);
		
		// 객체를 쓰고자 할때 원래는 이름이 있어야 한다.
		// 이름 있는 클래스는 메인뿐아니라 다른 클래스에서 사용할 수 있다
		// 프로그래밍을 하다보면 메인에서 한번만 사용해야 할 때가 있다.
		// 그 때 사용하는 것이 무명클래스이다.
