...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    //     한번의 설정으로 $("input#fromDate"), $('input#toDate')의 옵션을 모두 설정할 수 있다.
     ...
     $("img#idcheck").click( ()=>{
    	  ...
    	  /*
		    ...
		    ==> 이름만 보면 알 수 있듯이 '비동기 방식의 자바스크립트와 XML' 로서
		        ...
		        JSON(JavaScript Object Notation) 은 {"key1":"data1", "key2":"data2", "key3":data3} 이러한 모양을 띄는 것을 말한다.
        	  ...
        	  //  async:false,  // 동기처리(지도는 동기처리로 해야 한다)
        	     ...
        	     //	  console.log("확인용 => " + json.isExist);
        	    	  ...
        	    	  if(json.isExist) {
        	    		  ...
        	    		  // 입력한 $("input#userid").val() 값이 DB의 tbl_member 테이블에 존재하지 않는 경우라면 
     ...
     // 아이디값이 변경되면 가입하기 버튼 클릭시 "아이디중복확인" 을 클릭했는지 클릭안했는지를 알아보기위한 용도를 초기화 시키기
    	   ...
    	   // async:false,  // 동기처리(지도는 동기처리로 해야 한다)
    	      ...
    	      //  console.log("확인용 typeof(json) => " + typeof(json));
    	    	  ...
    	    	  if(json.isExist) {
    	    		  ...
    	    		  // 입력한 $("input#email").val() 값이 DB의 tbl_member 테이블에 존재하지 않는 경우라면 
