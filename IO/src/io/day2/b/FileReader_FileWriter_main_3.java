...
public class FileReader_FileWriter_main_3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// args[0] 은 C:/iotestdata/애국가2.txt 으로 하고		애국가2.txt 파일은 인코딩이 ANSI 이고,
			// args[1] 은 C:/iotestdata/애국가2_복사본.txt 으로 한다.
			
			// args[0] 은 C:/iotestdata/애국가.txt 으로 하고		애국가.txt 파일은 인코딩이 UTF-8 이고,
			// args[1] 은 C:/iotestdata/애국가_copy.txt 으로 한다.
			
			System.out.println(args[0]+"을 "+args[1]+"로 복사완료함!!");
			
		} catch (FileNotFoundException e) { //IOException에서 FileNotFoundException을 포함한다.
...
/*
 	실행은 아래와 같이 함.
 	C:\Users\choib\git\Ssangyong\IO\bin
 	
 	C:\Users\choib\git\Ssangyong\IO\bin>java io.day2.b.FileReader_FileWriter_main_3 C:\iotestdata\애국가2.txt C:\iotestdata\애국가2_복사본.txt
